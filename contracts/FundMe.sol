...
contract FundMe {
    ...
    function fund() public payable {
        // we can set the price to whatever we want. Let's do $50
        uint256 minimum = 60*(10**18);
        require(getConversionRate(msg.value) >= minimum, "Fuck off Tiger");
    ...
    function getConversionRate(uint256 ethAmt) public view returns (uint256) {
        ...
        return (ethAmt*ethPrice)/100000000;
    }
